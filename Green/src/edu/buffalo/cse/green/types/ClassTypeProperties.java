...
import edu.buffalo.cse.green.dialogs.wizards.NewClassWizard;


/**
 * A plugin to add classes to Green's editor.
 * 
 * @author bcmartin
 */
public class ClassTypeProperties implements ITypeProperties {
	/**
