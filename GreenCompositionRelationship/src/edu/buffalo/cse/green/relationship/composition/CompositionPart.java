 ...
 * @author bcmartin
 */
public class CompositionPart extends RelationshipPart {
	/**
	...
	public RotatableDecoration createSourceArrow() {
		PolygonDecoration sourceArrow = new PolygonDecoration();
		PointList points = new PointList();
		points.addPoint(0, 0);
		points.addPoint(-1, 1);
		points.addPoint(-2, 0);
		points.addPoint(-1, -1);
		sourceArrow.setTemplate(points);
		sourceArrow.setScale(11, 7);
		return sourceArrow;
	}
